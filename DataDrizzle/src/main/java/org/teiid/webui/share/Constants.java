...
public class Constants {
    ...
    public static final String createdBy = "DataDrizzle"; //$NON-NLS-1$
    public static final String TEST="TEST";
    public static final String CONNECTION_NAME = "connectionName";
    public static final String CONNECTION_DATABASE = "DatabaseName";
    public static final String CONNECTION_DATABASE_TYPE = "connectionDatabaseType";
    ...
    public static final String DS_PROP_JNDI_NAME = "jndi-name";
    public static final String DS_PROP_POOL_NAME = "pool-name";
    public static final String DS_PROP_ENABLE = "enabled";
    public static final String DS_PROP_CONNECTION_URL = "connection-url";
    public static final String DS_PROP_USER_NAME = "user-name";
    public static final String DS_PROP_DRIVER_CLASS = "driver-class";
    public static final String DS_PROP_XA_DRIVER_CLASS = "xa-datasource-class";
    public static final String DS_PROP_PASSWORD = "password";
    
    public static final String DS_PROP_SERVERNAME = "ServerName";
    public static final String DS_PROP_PORT_NUMBER = "PortNumber";
    public static final String DS_PROP_PREFILL_KEY = "prefill";
    public static final String DS_PROP_PREFILL_VALUE = "prefill";
    public static final String DS_PROP_NO_TX_SEPARATE_POOLS = "no-tx-separate-pools";
    public static final String DS_PROP_DATABASE_NAME = "DatabaseName";
    public static final String DS_PROP_MAX_POOL_SIZE_KEY = "max-pool-size";
    public static final String DS_PROP_MAX_POOL_SIZE_VALUE = "1";
    public static final String DS_PROP_MIN_POOL_SIZE_KEY = "min-pool-size";
    public static final String DS_PROP_MIN_POOL_SIZE_VALUE = "1";
    public static final String DS_PROP_USE_JAVA_CONTEXT_KEY = "use-java-context";
    public static final String DS_PROP_USE_STRICT_MIN = "use-strict-min";
    public static final String DS_PROP_FLUSH_STRATEGY_KEY = "flush-strategy";
    public static final String DS_PROP_IS_SAME_RM_OVERRIDE = "is-same-rm-override";
    
    public static final String DS_PROP_FLUSH_STRATEGY_VALUE = "FailingConnectionOnly";
    
    public static String UDF = "CREATE VIRTUAL FUNCTION celsiusToFahrenheit(celsius DOUBLE) RETURNS DOUBLE OPTIONS (JAVA_CLASS   'org.something.TempConv',  JAVA_METHOD 'celsiusToFahrenheit'); "
