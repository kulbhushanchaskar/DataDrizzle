...
public class UpdateModeJob implements Job {

	private Logger log = Logger.getLogger(UpdateModeJob.class);
	...
	public void execute(JobExecutionContext jExeCtx) throws JobExecutionException {
		...
		moveDataToUpdateJobTable(jExeCtx);
...
//			    Connection con = DriverManager.getConnection("jdbc:hive2://localhost:10000/default", "", "");
	...
	private void moveDataToUpdateJobTable(JobExecutionContext jExeCtx) {
		...
		try {
			...
			List<HashMap<String, String>> rowsChangeList = executeSelect(connection, select_par_sql);
